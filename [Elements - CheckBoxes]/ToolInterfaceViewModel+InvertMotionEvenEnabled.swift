...
extension ToolInterfaceViewModel {
    ...
    func getInvertMotionEvenEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelInvertMotionEvenEnabled = MagicalCheckBoxViewModelInvertMotionEvenEnabled(jiggleViewModel: jiggleViewModel,
