...
extension ToolInterfaceViewModel {
    ...
    func getReverseMotionOddEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelReverseMotionOddEnabled = MagicalCheckBoxViewModelReverseMotionOddEnabled(jiggleViewModel: jiggleViewModel,
