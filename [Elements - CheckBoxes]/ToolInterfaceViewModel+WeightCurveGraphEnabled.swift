...
extension ToolInterfaceViewModel {
    ...
    func getWeightCurveGraphEnabledCheckBoxNode(neighborTypeLeft: ToolInterfaceElementType?,
        ...
        let viewModelWeightCurveGraphEnabled = MagicalCheckBoxViewModelWeightCurveGraphEnabled(jiggleViewModel: jiggleViewModel,
