//
//  ToolInterfaceViewModel+CircleFactor.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getCircleFactorSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextCircleFactorLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextCircleFactorLine2()
        ...
        */
        ...
        let viewModelCircleFactor = MagicalSliderViewModelCircleFactor(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderCircleFactor,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelCircleFactor,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelCircleFactor.refresh()
        return result
    }
}
