//
//  ToolInterfaceViewModel+InflateAmount.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getInflateAmountSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextInflateAmountLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextInflateAmountLine2()
        ...
        */
        ...
        let viewModelInflateAmount = MagicalSliderViewModelInflateAmount(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderInflateAmount,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelInflateAmount,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelInflateAmount.refresh()
        return result
    }
}
