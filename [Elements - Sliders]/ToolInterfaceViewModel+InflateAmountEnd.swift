//
//  ToolInterfaceViewModel+InflateAmountEnd.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getInflateAmountEndSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextInflateAmountEndLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextInflateAmountEndLine2()
        ...
        */
        ...
        let viewModelInflateAmountEnd = MagicalSliderViewModelInflateAmountEnd(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderInflateAmountEnd,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelInflateAmountEnd,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelInflateAmountEnd.refresh()
        return result
    }
}
