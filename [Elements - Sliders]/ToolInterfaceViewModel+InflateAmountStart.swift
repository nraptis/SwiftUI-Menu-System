//
//  ToolInterfaceViewModel+InflateAmountStart.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getInflateAmountStartSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextInflateAmountStartLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextInflateAmountStartLine2()
        ...
        */
        ...
        let viewModelInflateAmountStart = MagicalSliderViewModelInflateAmountStart(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderInflateAmountStart,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelInflateAmountStart,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelInflateAmountStart.refresh()
        return result
    }
}
