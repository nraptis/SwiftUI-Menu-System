//
//  ToolInterfaceViewModel+LoopSpeed.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getLoopSpeedSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextLoopSpeedLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextLoopSpeedLine2()
        ...
        */
        ...
        let viewModelLoopSpeed = MagicalSliderViewModelLoopSpeed(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderLoopSpeed,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelLoopSpeed,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelLoopSpeed.refresh()
        return result
    }
}
