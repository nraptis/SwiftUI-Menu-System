//
//  ToolInterfaceViewModel+SwivelCameraPan.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelCameraPanSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraPanLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraPanLine2()
        ...
        */
        ...
        let viewModelSwivelCameraPan = MagicalSliderViewModelSwivelCameraPan(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelCameraPan,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelCameraPan,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelCameraPan.refresh()
        return result
    }
}
