//
//  ToolInterfaceViewModel+SwivelCameraTilt.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelCameraTiltSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraTiltLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraTiltLine2()
        ...
        */
        ...
        let viewModelSwivelCameraTilt = MagicalSliderViewModelSwivelCameraTilt(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelCameraTilt,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelCameraTilt,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelCameraTilt.refresh()
        return result
    }
}
