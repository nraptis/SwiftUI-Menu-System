//
//  ToolInterfaceViewModel+SwivelCameraTwist.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelCameraTwistSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraTwistLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraTwistLine2()
        ...
        */
        ...
        let viewModelSwivelCameraTwist = MagicalSliderViewModelSwivelCameraTwist(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelCameraTwist,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelCameraTwist,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelCameraTwist.refresh()
        return result
    }
}
