//
//  ToolInterfaceViewModel+SwivelCameraZoom.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelCameraZoomSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraZoomLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelCameraZoomLine2()
        ...
        */
        ...
        let viewModelSwivelCameraZoom = MagicalSliderViewModelSwivelCameraZoom(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelCameraZoom,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelCameraZoom,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelCameraZoom.refresh()
        return result
    }
}
