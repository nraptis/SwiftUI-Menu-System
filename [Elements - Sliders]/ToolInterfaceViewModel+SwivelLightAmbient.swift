//
//  ToolInterfaceViewModel+SwivelLightAmbient.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelLightAmbientSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelLightAmbientLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelLightAmbientLine2()
        ...
        */
        ...
        let viewModelSwivelLightAmbient = MagicalSliderViewModelSwivelLightAmbient(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelLightAmbient,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelLightAmbient,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelLightAmbient.refresh()
        return result
    }
}
