//
//  ToolInterfaceViewModel+SwivelLightDiffuse.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelLightDiffuseSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelLightDiffuseLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelLightDiffuseLine2()
        ...
        */
        ...
        let viewModelSwivelLightDiffuse = MagicalSliderViewModelSwivelLightDiffuse(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelLightDiffuse,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelLightDiffuse,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelLightDiffuse.refresh()
        return result
    }
}
