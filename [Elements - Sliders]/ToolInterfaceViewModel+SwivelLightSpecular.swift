//
//  ToolInterfaceViewModel+SwivelLightSpecular.swift
//  Jiggle3
//
...
extension ToolInterfaceViewModel {
    func getSwivelLightSpecularSliderToolNode(widthCategory: ToolInterfaceElementSliderWidthCategory,
                                      neighborTypeLeft: ToolInterfaceElementType?,
                                      neighborTypeRight: ToolInterfaceElementType?) -> ToolNode {
        let orientation = jiggleViewModel.jiggleDocument.orientation
        let textLine1 = ToolInterfaceStringLibrarySliders.sliderTextSwivelLightSpecularLine1()
        let textLine2 = ToolInterfaceStringLibrarySliders.sliderTextSwivelLightSpecularLine2()
        ...
        */
        ...
        let viewModelSwivelLightSpecular = MagicalSliderViewModelSwivelLightSpecular(jiggleViewModel: jiggleViewModel,
                                                                     toolInterfaceViewModel: self,
                                                                     sliderConfiguration: configuration)
        let result = ToolNode(id: getToolNodeID(),
                              element: .sliderSwivelLightSpecular,
                              flex: flex,
                              toolInterfaceViewModel: self,
                              magicalViewModel: viewModelSwivelLightSpecular,
                              neighborTypeLeft: neighborTypeLeft,
                              neighborTypeRight: neighborTypeRight)
        viewModelSwivelLightSpecular.refresh()
        return result
    }
}
