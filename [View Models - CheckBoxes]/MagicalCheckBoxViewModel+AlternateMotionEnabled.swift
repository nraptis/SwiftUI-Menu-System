//
//  MagicalCheckBoxViewModel+AlternateMotionEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelAlternateMotionEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelAlternateMotionEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelAlternateMotionEnabled - Dealloc")
    }
}
