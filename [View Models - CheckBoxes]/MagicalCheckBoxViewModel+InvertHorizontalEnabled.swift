//
//  MagicalCheckBoxViewModel+InvertHorizontalEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelInvertHorizontalEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelInvertHorizontalEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelInvertHorizontalEnabled - Dealloc")
    }
}
