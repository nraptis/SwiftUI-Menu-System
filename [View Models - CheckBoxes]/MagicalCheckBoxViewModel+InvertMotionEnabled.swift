//
//  MagicalCheckBoxViewModel+InvertMotionEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelInvertMotionEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelInvertMotionEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelInvertMotionEnabled - Dealloc")
    }
}
