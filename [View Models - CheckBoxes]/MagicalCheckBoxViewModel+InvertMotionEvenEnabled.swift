//
//  MagicalCheckBoxViewModel+InvertMotionEvenEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelInvertMotionEvenEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelInvertMotionEvenEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelInvertMotionEvenEnabled - Dealloc")
    }
}
