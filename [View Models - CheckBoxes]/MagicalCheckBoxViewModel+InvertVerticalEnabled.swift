//
//  MagicalCheckBoxViewModel+InvertVerticalEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelInvertVerticalEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelInvertVerticalEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelInvertVerticalEnabled - Dealloc")
    }
}
