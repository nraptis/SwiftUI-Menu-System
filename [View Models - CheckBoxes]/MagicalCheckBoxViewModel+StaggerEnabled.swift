//
//  MagicalCheckBoxViewModel+StaggerEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelStaggerEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelStaggerEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelStaggerEnabled - Dealloc")
    }
}
