//
//  MagicalCheckBoxViewModel+UndershootEnabled.swift
//  Jiggle3
//
...
@Observable class MagicalCheckBoxViewModelUndershootEnabled: MagicalCheckBoxViewModel {
    ...
    override func handleClicked() {
        print("MagicalCheckBoxViewModelUndershootEnabled => handleClicked()")
    ...
    deinit {
        print("MagicalCheckBoxViewModelUndershootEnabled - Dealloc")
    }
}
