//
//  MagicalSliderViewModel+CircleFactor.swift
//  Jiggle3
//
...
@Observable class MagicalSliderViewModelCircleFactor: MagicalSliderViewModel {
    ...
    deinit {
        print("MagicalSlider CircleFactor - Dealloc")
    }
    ...
    override func handleSlideStarted(percent: CGFloat) {
        ...
        jiggleViewModel.notifySliderStartedCircleFactor(value: value)
    }
    ...
    override func handleSlideFinished(percent: CGFloat) {
        ...
        */
        jiggleViewModel.notifySliderFinishedCircleFactor(value: value)
    }
}
