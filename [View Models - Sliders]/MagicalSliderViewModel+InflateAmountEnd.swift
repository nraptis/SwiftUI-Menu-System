//
//  MagicalSliderViewModel+InflateAmountEnd.swift
//  Jiggle3
//
...
@Observable class MagicalSliderViewModelInflateAmountEnd: MagicalSliderViewModel {
    ...
    deinit {
        print("MagicalSlider InflateAmountEnd - Dealloc")
    }
    ...
    override func handleSlideStarted(percent: CGFloat) {
        ...
        jiggleViewModel.notifySliderStartedInflateAmountEnd(value: value)
    }
    ...
    override func handleSlideFinished(percent: CGFloat) {
        ...
        */
        jiggleViewModel.notifySliderFinishedInflateAmountEnd(value: value)
    }
}
