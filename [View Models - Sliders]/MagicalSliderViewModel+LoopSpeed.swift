//
//  MagicalSliderViewModel+LoopSpeed.swift
//  Jiggle3
//
...
@Observable class MagicalSliderViewModelLoopSpeed: MagicalSliderViewModel {
    ...
    deinit {
        print("MagicalSlider LoopSpeed - Dealloc")
    }
    ...
    override func handleSlideStarted(percent: CGFloat) {
        ...
        jiggleViewModel.notifySliderStartedLoopSpeed(value: value)
    }
    ...
    override func handleSlideFinished(percent: CGFloat) {
        ...
        */
        jiggleViewModel.notifySliderFinishedLoopSpeed(value: value)
    }
}
