//
//  MagicalSliderViewModel+MovementHorizontal.swift
//  Jiggle3
//
...
@Observable class MagicalSliderViewModelMovementHorizontal: MagicalSliderViewModel {
    ...
    deinit {
        print("MagicalSlider MovementHorizontal - Dealloc")
    }
    ...
    override func handleSlideStarted(percent: CGFloat) {
        ...
        jiggleViewModel.notifySliderStartedMovementHorizontal(value: value)
    }
    ...
    override func handleSlideFinished(percent: CGFloat) {
        ...
        */
        jiggleViewModel.notifySliderFinishedMovementHorizontal(value: value)
    }
}
