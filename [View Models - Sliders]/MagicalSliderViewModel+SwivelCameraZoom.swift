//
//  MagicalSliderViewModel+SwivelCameraZoom.swift
//  Jiggle3
//
...
@Observable class MagicalSliderViewModelSwivelCameraZoom: MagicalSliderViewModel {
    ...
    deinit {
        print("MagicalSlider SwivelCameraZoom - Dealloc")
    }
    ...
    override func handleSlideStarted(percent: CGFloat) {
        ...
        jiggleViewModel.notifySliderStartedSwivelCameraZoom(value: value)
    }
    ...
    override func handleSlideFinished(percent: CGFloat) {
        ...
        */
        jiggleViewModel.notifySliderFinishedSwivelCameraZoom(value: value)
    }
}
